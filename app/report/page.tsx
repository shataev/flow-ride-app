    ...
    <div className="min-h-dvh bg-zinc-50 dark:bg-zinc-950">
      ...
      <main className="mx-auto max-w-2xl px-4 py-8">
        ...
        <p className="mt-2 text-zinc-600 dark:text-zinc-400">
          To report a traffic event, open the map and tap on the location where the event occurred. 
          A modal will open where you can choose the event type and add a description.
        </p>
        <div className="mt-8 rounded-xl border border-zinc-200 bg-white p-6 dark:border-zinc-800 dark:bg-zinc-900">
          ...
          <ol className="mt-3 list-decimal list-inside space-y-2 text-sm text-zinc-600 dark:text-zinc-400">
            ...
            <li>Tap on the map at the event location.</li>
            <li>Select the event type (Checkpoint, Accident, Hazard, Roadblock).</li>
