    ...
    <div className="min-h-dvh bg-zinc-50 dark:bg-zinc-950">
      ...
      <main className="mx-auto max-w-2xl px-4 py-8">
        ...
        <p className="mt-2 text-zinc-600 dark:text-zinc-400">
          To report a traffic event, open the map and either search for a place in the bar at the
          top or tap directly on the map. A modal will open where you can choose the event type and
          add a description.
        </p>
